      ...
      <section className="content-wrapper interactive-intro">
        ...
        <div className="interactive-intro-card">
          <p className="interactive-intro-text">
            Наш музей — это мультимедийное пространство, где история оживает в современном формате. Мы объединили глубину классических статей с наглядностью редких кадров.
          </p>
          ...
          <ul className="interactive-intro-list">
            ...
            <li><strong>• Смотрите:</strong> Эксклюзивные архивные фотографии.</li>
            <li><strong>• Исследуйте:</strong> Рассматривайте важные мелочи на детальных снимках в собственном темпе.</li>
          </ul>
        </div>
      </section>
